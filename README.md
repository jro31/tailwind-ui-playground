A play around with the free components from the Tailwind UI Components library, starting from [Create React App](https://github.com/facebook/create-react-app).
